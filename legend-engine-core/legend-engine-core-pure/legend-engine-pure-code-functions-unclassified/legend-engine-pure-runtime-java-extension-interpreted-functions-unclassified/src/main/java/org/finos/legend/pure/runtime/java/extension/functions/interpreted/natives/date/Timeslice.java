...
public class Timeslice implements NativeFunction
{
    private final ModelRepository repository;

    public Timeslice(ModelRepository repository)
    {
    ...
    {
        // This is just a placeholder - the actual implementation is in the execution plans
