...
public class LateralJoin extends AbstractNative implements Native
{
    public LateralJoin()
    {
        super("lateralJoin_Relation_1__Relation_1__JoinKind_1__Function_1__Relation_1_");
    }

    @Override
    public String build(CoreInstance topLevelElement, CoreInstance functionExpression, ListIterable<String> transformedParams, ProcessorContext processorContext)
    {
        StringBuilder result = new StringBuilder("org.finos.legend.pure.runtime.java.extension.external.relation.compiled.RelationNativeImplementation.lateralJoin");
        result.append('(');
