...
public class Having extends AbstractNative implements Native
{
    public Having()
    {
    ...
    {
        StringBuilder result = new StringBuilder("org.finos.legend.pure.runtime.java.extension.external.relation.compiled.RelationNativeImplementation.having");
        result.append('(');
